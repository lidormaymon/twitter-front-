...
const Login = () => {
    ...
    return (
        <div className="container p-4 border-gray-600 border-2 w-72 md:w-100 h-fit flex flex-col relative left-14 2xl:left-16 3xl:left-40 top-20 items-center justify-center rounded-lg">
